...
const greetTripled = (greeting, value) => {
...
const makeFruitSalad = (fruit1, fruit2) => {
    let salad = fruit1 + fruit2 + fruit2 + fruit1 + fruit1 + fruit2;
    console.log(salad);
};
makeFruitSalad("banana", "orange");
const repeatSyllableSong = (syllable, repeatNumber) => {
    let song = "";
...
const myAnswer = factorFiction();
console.log(myAnswer);
const sillyNameGenerator = (index1, index2) => {
